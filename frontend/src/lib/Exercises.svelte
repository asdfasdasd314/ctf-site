<script lang="ts">
    ...
    let exercise: Exercise = {
      ...
      description: 'Find and exploit vulnerabilities in the authentication system to gain unauthorized access.',
      difficulty: 'Beginner',
      category: 'Web',
      points: 100,
      solveCount: 0,
    ...
    <div class="container mx-auto max-w-4xl px-4">
      {#if isLoading}
        <div class="text-center py-20">
          <svg class="animate-spin mx-auto h-12 w-12 text-emerald-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        >
          ...
          <div class="p-6">
            ...
            <div class="flex justify-between items-start mb-3">
              ...
              <span class="text-xs font-medium px-2 py-1 rounded-full ml-2 whitespace-nowrap bg-emerald-100 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-200">
                {exercise.difficulty}
              </span>
            </div>
